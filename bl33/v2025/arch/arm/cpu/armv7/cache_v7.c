...
{
	uintptr_t bl33z_entry = (uintptr_t)_end;
	void (*func_tpl)(void) = (void (*)(void))bl33z_entry;
...
__weak __attribute__((optimize("O2","omit-frame-pointer")))  void v7_outer_cache_flush_all(void) {}

...
typedef struct __attribute__((__packed__)) efuse_cali {
	...
	unsigned long long tsensor2_data:15;
	unsigned long long tsensor2_flag:1;
	unsigned long long tsensor3_data:15;
	unsigned long long tsensor3_flag:1;
	...
	unsigned long long dpaux_tx_data:3;
	unsigned long long dpaux_tx_flag:1;
	unsigned long long usbphy_data:4;
	...
	unsigned long long upcdp_tx_io_data:6;
	unsigned long long upcdp_tx_io_flag:1;
	unsigned long long upcdp_tx_bootst_data:5;
	unsigned long long upcdp_tx_bootst_flag:1;
	unsigned long long upcdp_reg_dcha_data:4;
	unsigned long long upcdp_reg_dcha_flag:1;
	unsigned long long usb3_upctx_io_data:6;
	unsigned long long usb3_upctx_io_flag:1;
	unsigned long long usb3_upctx_bootst_data:5;
	unsigned long long usb3_upctx_bootst_flag:1;
	unsigned long long usb3_upcreg_dcha_data:4;
	unsigned long long usb3_upcreg_dcha_flag:1;
	unsigned long long u3pcie_tx_data:4;
	...
	unsigned long long earctx_data:5;
	unsigned long long earctx_flag:1;
	unsigned long long reserved1:1;
	unsigned long long comb_vml_res_data:4;
	unsigned long long comb_vml_res_flag:1;
	unsigned long long comb_lvds_res_data:4;
	unsigned long long comb_lvds_res_flag:1;
	unsigned long long comb_current_data:5;
	unsigned long long comb_current_flag:1;
} efuse_cali_t;

#define EFUSE_CALI_SIZE			29

#define EFUSE_BYTES				1024   /* (EFUSE_BITS/8) */

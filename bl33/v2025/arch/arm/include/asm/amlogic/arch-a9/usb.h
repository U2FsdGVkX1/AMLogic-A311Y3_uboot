...
#define PHY_REGISTER_SIZE	0x0

#define USB_POC4(poc)       ((poc) >> 4 & 1)
#define POC_USB_CHANNEL_A(poc)  (!USB_POC4(poc))

#define DWC3_UDC_BASE        (u64)((POC_USB_CHANNEL_A(*(u32 *)\
        ((0x0060  << 2) + 0xfe010000)) ? 0xf3b00000 : 0xf3f00000))

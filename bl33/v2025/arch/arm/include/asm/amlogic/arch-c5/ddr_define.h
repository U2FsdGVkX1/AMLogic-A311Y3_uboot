...
#define LPDDR5_8BANK_MODE  0
#define LPDDR5_BG_MODE  1
#define LPDDR5_16BANK_MODE  2
...
#define CONFIG_CH0_CS0_BYTE_01_SIZE_512_ID_OFFSET                 0
#define CONFIG_CH0_CS0_BYTE_23_SIZE_512_ID_OFFSET                 4
#define CONFIG_CH0_CS1_BYTE_01_SIZE_512_ID_OFFSET                 8
#define CONFIG_CH0_CS1_BYTE_23_SIZE_512_ID_OFFSET                 12
#define CONFIG_CH1_CS0_BYTE_01_SIZE_512_ID_OFFSET                 16
#define CONFIG_CH1_CS0_BYTE_23_SIZE_512_ID_OFFSET                 20
#define CONFIG_CH1_CS1_BYTE_01_SIZE_512_ID_OFFSET                 24
#define CONFIG_CH1_CS1_BYTE_23_SIZE_512_ID_OFFSET                 28
#define CONFIG_CS0_BYTE_01_SIZE_512_ID_OFFSET                     0
#define CONFIG_CS0_BYTE_23_SIZE_512_ID_OFFSET                     4
#define CONFIG_CS1_BYTE_01_SIZE_512_ID_OFFSET                     8
#define CONFIG_CS1_BYTE_23_SIZE_512_ID_OFFSET                     12
...
#define DRAM_SIZE_ID_512MBX0                                      0
#define DRAM_SIZE_ID_512MBX1                                      1
#define DRAM_SIZE_ID_512MBX2                                      2
#define DRAM_SIZE_ID_512MBX3                                      3
#define DRAM_SIZE_ID_512MBX4                                      4
#define DRAM_SIZE_ID_512MBX5                                      5
#define DRAM_SIZE_ID_512MBX6                                      6
#define DRAM_SIZE_ID_512MBX7                                      7
#define DRAM_SIZE_ID_512MBX8                                      8
#define DRAM_SIZE_ID_512MBX9                                      9
#define DRAM_SIZE_ID_512MBX10                                     10
#define DRAM_SIZE_ID_512MBX11                                     11
#define DRAM_SIZE_ID_512MBX12                                     12
#define DRAM_SIZE_ID_512MBX13                                     13
#define DRAM_SIZE_ID_512MBX14                                     14
#define DRAM_SIZE_ID_512MBXAUTO                                   15
...
#define DDR_FUNC_CONFIG_FORCE_DISABLE_DDR_EFUSE                   (0 + (1 << 15))
#define DDR_FUNC_CONFIG_RX_REPLICA_VT_ENABLE                   (0 + (1 << 16))
#define DDR_FUNC_CONFIG_WR_ECC_FUNCTION                       (0 + (1 << 17))
#define DDR_FUNC_CONFIG_FORCE_LP4_A17_ADD                   (0 + (1 << 18))
...
#define DDR_RFC_TYPE_LPDDR5_2Gbx1 19
#define DDR_RFC_TYPE_LPDDR5_3Gbx1 20
#define DDR_RFC_TYPE_LPDDR5_12Gbx1 21
#define DDR_RFC_TYPE_LPDDR5_16Gbx1 22
#define DDR_RFC_TYPE_LPDDR5_24Gbx1 23
#define DDR_RFC_TYPE_LPDDR5_32Gbx1 24
...
#define DDR_DMC_REMAP_PXP_DDR4_32BIT                                                           \
	{                                                                                      \
		[0] = (5 | 7 << 5 | 8 << 10 | 9 << 15 | 10 << 20 | 11 << 25),              \
		[1] = (12 | 0 << 5 |  0 << 10 | 13 << 15 | 16 << 20 | 17 << 25),            \
		[2] = (18 | 19 << 5 | 20 << 10 | 21 << 15 | 22 << 20 | 23 << 25),          \
		[3] = (24 | 25 << 5 | 26 << 10 | 27 << 15 | 28 << 20 | 29 << 25),          \
		[4] = (30 | 14 << 5 | 15 << 10 | 6 << 15  |  0 << 20 |  0 << 25),            \
	}
...
#define DDR_DMC_REMAP_DDR4_16BIT_1                                                           \
	{                                                                                      \
		[0] = (0 | 5 << 5 | 6 << 10 | 7 << 15 | 8 << 20 | 9 << 25),                     \
		[1] = (10 | 0 << 5 | 0 << 10 | 14 << 15 | 15 << 20 | 16 << 25),                 \
		[2] = (17 | (18 << 5) | (19 << 10) | (20 << 15) | (21 << 20) | (22 << 25)),     \
...
#define DDR_DMC_REMAP_DDR4_16BIT_S1A                                                         \
	{                                                                                   \
...
#define DDR_DMC_REMAP_LPDDR4_16BIT                                                         \
	{                                                                                      \
		...
		[2] = (17 | (18 << 5) | (19 << 10) | (20 << 15) | (21 << 20) | (22 << 25)),   \
		[3] = (23 | 24 << 5 | 25 << 10 | 26 << 15 | 27 << 20 | 28 << 25),             \
		[4] = (29 | 12 << 5 | 13 << 10 | 14 << 15 | 31 << 20 | 30 << 25),               \
	}
...
#define DDR_DMC_REMAP_DDR3_16BIT_S1A                       \
	{                                                          \
    [0] = (  4|  5 << 5 |  6 << 10 |  7 << 15 |  8 << 20 | 9 << 25 ) ,\
    [1] = ( 10|  0 << 5 |  0 << 10 | 14 << 15 | 15 << 20 | 16 << 25 ) ,\
    [2] = ( 17| 18 << 5 | 19 << 10 | 20 << 15 | 21 << 20 | 22 << 25 ) ,\
    [3] = ( 23| 24 << 5 | 25 << 10 | 26 << 15 | 27 << 20 | 28 << 25 ) ,\
    [4] = ( 29| 11 << 5 | 12 << 10 | 13  << 15 |  0 << 20 |  0 << 25 ) ,\
...
#define    READ_CMD_INDEX  0xe2
#define    ACTIVE_CMD_INDEX  0xe1
#define    LP5_CSH_CMD  0xdd
#define    CMD_LP5_WCK_ON  0xdc
#define    CMD_LP5_WCK_OFF  0xdb
...
#define    LP5_MPC_CMD_START_DQI_OSC  0x81
#define    LP5_MPC_CMD_STOP_DQI_OSC  0x82
#define    LP5_MPC_CMD_START_DQO_OSC  0x83
#define    LP5_MPC_CMD_STOP_DQO_OSC  0x84
#define    LP5_MPC_CMD_ZQ_START  0x85
#define    LP5_MPC_CMD_ZQ_LATCH  0x86
...
#define  ACSM_CMD_LP5_CSH 0x3
#define  ACSM_CMD_LP5_WCK_ON  0x7
#define  ACSM_CMD_LP5_WCK_OFF  0x8
#define  ACSM_CMD_SRE  0xc
#define  ACSM_CMD_SRX  0xe
#define  ACSM_CMD_TRAINING  0xf
#define  ACSM_CMD_LP5_WR_32  0x4
#define  ACSM_CMD_LP5_RD_32  0x5
#define  ACSM_CMD_LP5_WR_16  0x1
#define  ACSM_CMD_LP5_RD_16  0x2

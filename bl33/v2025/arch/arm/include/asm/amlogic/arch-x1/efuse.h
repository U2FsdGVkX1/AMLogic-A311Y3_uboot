...
typedef struct __attribute__((__packed__)) efuse_cali {
	...
	unsigned long long usb3_upctx_bootst_data:4;
	...
	unsigned long long pcie_upctx_calibdrv_data:4;
	unsigned long long pcie_upctx_calibdrv_flag:1;
	unsigned long long pcie_upctx_bootst_data:4;
	unsigned long long pcie_upctx_bootst_flag:1;
	unsigned long long pcie_upcreg_dcha_data:4;
	unsigned long long pcie_upcreg_dcha_flag:1;
	unsigned long long reserved1:3;
	//Cali info2
	unsigned long long eth_a_gphy_rext_data:4;
	unsigned long long eth_a_gphy_rext_flag:1;
	unsigned long long eth_a_gphy_driver_data:8;
	unsigned long long eth_a_gphy_driver_flag:1;
	unsigned long long eth_b_gphy_driver_data:8;
	unsigned long long eth_b_gphy_driver_flag:1;
	unsigned long long eth_c_gphy_driver_data:8;
	unsigned long long eth_c_gphy_driver_flag:1;
	unsigned long long eth_d_gphy_driver_data:8;
	unsigned long long eth_d_gphy_driver_flag:1;
	unsigned long long saradc_vref_data:6;
	unsigned long long saradc_vref_flag:1;
	unsigned long long saradc_rsv2_data:7;
	unsigned long long saradc_rsv2_flag:1;
} efuse_cali_t;

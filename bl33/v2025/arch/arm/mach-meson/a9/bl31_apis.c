...
const struct t_efuse_item efusecaliitem_cfg[] = {
	...
	{.name = "sensor2", .item = EFUSE_CALI_SUBITEM_SENSOR2},
	{.name = "sensor3", .item = EFUSE_CALI_SUBITEM_SENSOR3},
	{.name = "cclogic", .item = EFUSE_CALI_SUBITEM_USBCCLOGIC},
	{.name = "csi", .item = EFUSE_CALI_SUBITEM_CSI},
	{.name = "dpaux_tx", .item = EFUSE_CALI_SUBITEM_DPAUX_TX},
	...
	{.name = "upcdp_tx_io", .item = EFUSE_CALI_SUBITEM_UPCDP_TX_IO},
	{.name = "upcdp_tx_bootst", .item = EFUSE_CALI_SUBITEM_UPCDP_TX_BOOTST},
	{.name = "upcdp_reg_dcha", .item = EFUSE_CALI_SUBITEM_UPCDP_REG_DCHA},
	...
	{.name = "comb_vml_res", .item = EFUSE_CALI_SUBITEM_COMB_VML_RES},
	{.name = "comb_lvds_res", .item = EFUSE_CALI_SUBITEM_COMB_LVDS_RES},
	{.name = "comb_current", .item = EFUSE_CALI_SUBITEM_COMB_CURRENT},
};

...
unsigned int ts_cfg_reg1[4] = {TS_A55_CFG_REG1, TS_CORE_CFG_REG1, TS_PLL_CFG_REG1, TS_DOS_CFG_REG1};
unsigned int ts_state0_reg[4] = {TS_A55_STAT0, TS_CORE_STAT0, TS_PLL_STAT0, TS_DOS_STAT0};
char *sensor_name[4] = {"a55", "gpu","pll", "dos"};

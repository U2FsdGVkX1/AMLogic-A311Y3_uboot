...
void set21_s7_htxpll_clk_out(const u32 clk, u32 div)
{
	...
	set_s7_htxpll_clk_other(clk, hdev->para->frl_rate ? 1 : 0);
...
static void set_hdmitx_s7_htx_pll(struct hdmitx_dev *hdev)
{
	...
	/* Firstly multiplied by 10 times of pixel clock, then down shift 1.001 more precisely */

...
{
	hd21_set_reg_bits(PADCTRL_PIN_MUX_REGB, 1, 0, 4); // hdmitx_sda
	hd21_set_reg_bits(PADCTRL_PIN_MUX_REGB, 1, 4, 4); // hdmitx_scl
}
...
#undef RESET_HDMI_PHY
	...
	case HDMI_PHYPARA_3p7G:
		...
		hd21_write_reg(ANACTRL_HDMIPHY_CTRL3, 0x4ef00b);
		break;

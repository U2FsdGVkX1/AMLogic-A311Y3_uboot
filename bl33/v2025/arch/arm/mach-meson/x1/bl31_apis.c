...
int meson_efuse_audio_id_get_checknum(void *out, int len)
{
	...
	arm_smccc_smc(DOLBY_FW_AUDIO_ID_CHECK, sharemem_output_base, len, 0, 0, 0, 0, 0, &res);

	ret = res.a0;
	if (ret == 0)
		memcpy((void *)out, (void *)sharemem_output_base, len);
...
const struct t_efuse_item efusecaliitem_cfg[] = {
	...
	{.name = "usb3_upctx_io", .item = EFUSE_CALI_SUBITEM_UPCTX_IO},
	{.name = "usb3_upctx_bootst", .item = EFUSE_CALI_SUBITEM_UPCTX_BOOTST},
	{.name = "usb3_upcreg_dcha", .item = EFUSE_CALI_SUBITEM_UPCREG_DCHA},
	{.name = "pcie_upctx_calibdrv", .item = EFUSE_CALI_SUBITEM_PCIE_UPCTX_CALIBDRV},
	{.name = "pcie_upctx_bootst", .item = EFUSE_CALI_SUBITEM_PCIE_UPCTX_BOOTST},
	{.name = "pcie_upcreg_dcha", .item = EFUSE_CALI_SUBITEM_PCIE_UPCREG_DCHA},
	{.name = "eth_a_gphy_rext", .item = EFUSE_CALI_SUBITEM_ETH_A_GPHY_REXT},
	{.name = "eth_a_gphy_driver", .item = EFUSE_CALI_SUBITEM_ETH_A_GPHY_DRIVER},
	{.name = "eth_b_gphy_driver", .item = EFUSE_CALI_SUBITEM_ETH_B_GPHY_DRIVER},
	{.name = "eth_c_gphy_driver", .item = EFUSE_CALI_SUBITEM_ETH_C_GPHY_DRIVER},
	{.name = "eth_d_gphy_driver", .item = EFUSE_CALI_SUBITEM_ETH_D_GPHY_DRIVER},
	{.name = "saradc_vref", .item = EFUSE_CALI_SUBITEM_SARADC_VREF},
	{.name = "saradc_rsv2", .item = EFUSE_CALI_SUBITEM_SARADC_RSV2},

...
int ts_a = 7243, ts_b = 2610, ts_m = 461, ts_n = 361;
unsigned int ts_cfg_reg1[2] = {TS_PLL_CFG_REG1, TS_EPP_CFG_REG1};
unsigned int ts_state0_reg[2] = {TS_PLL_STAT0, TS_EPP_STAT0};
char *sensor_name[2] = {"pll", "epp"};

...
/* SCTLR definitions */
#define SCTLR_RES1	(BIT(23) | BIT(22) | BIT(11) | BIT(4) | \
			BIT(3))
#define SCTLR_M_BIT			BIT(0)
#define SCTLR_A_BIT			BIT(1)
#define SCTLR_C_BIT			BIT(2)
#define SCTLR_CP15BEN_BIT	BIT(5)
#define SCTLR_ITD_BIT		BIT(7)
#define SCTLR_I_BIT			BIT(12)
#define SCTLR_V_BIT			BIT(13)
#define SCTLR_NTWI_BIT		BIT(16)
#define SCTLR_NTWE_BIT		BIT(18)
#define SCTLR_WXN_BIT		BIT(19)
#define SCTLR_UWXN_BIT		BIT(20)
#define SCTLR_EE_BIT		BIT(25)
#define SCTLR_TRE_BIT		BIT(28)
#define SCTLR_AFE_BIT		BIT(29)
#define SCTLR_TE_BIT		BIT(30)
...
/* HSCTLR definitions */
#define HSCTLR_RES1		(BIT(29) | BIT(28) | BIT(23) | BIT(22)	\
			| BIT(18) | BIT(16) | BIT(11) | BIT(4)	\
			| BIT(3))
#define HSCTLR_M_BIT		BIT(0)
#define HSCTLR_A_BIT		BIT(1)
#define HSCTLR_C_BIT		BIT(2)
#define HSCTLR_CP15BEN_BIT	BIT(5)
#define HSCTLR_ITD_BIT		BIT(7)
#define HSCTLR_SED_BIT		BIT(8)
#define HSCTLR_I_BIT		BIT(12)
#define HSCTLR_WXN_BIT		BIT(19)
#define HSCTLR_EE_BIT		BIT(25)
#define HSCTLR_TE_BIT		BIT(30)
...
#define SCR_SCD_BIT			BIT(7)
#define SCR_NET_BIT			BIT(6)
#define SCR_AW_BIT			BIT(5)
#define SCR_FW_BIT			BIT(4)
...
/* CNTHCTL definitions */
#define EVNTEN_BIT			BIT(2)
#define PL1PCEN_BIT			BIT(1)
#define PL1PCTEN_BIT		BIT(0)

/* CNTKCTL definitions */
#define PL0PTEN_BIT			BIT(9)
#define PL0VTEN_BIT			BIT(8)
#define PL0PCTEN_BIT		BIT(0)
#define PL0VCTEN_BIT		BIT(1)
#define EVNTEN_BIT			BIT(2)
#define EVNTDIR_BIT			BIT(3)
...
/* NASCR definitions */
#define NSASEDIS_BIT		BIT(15)
#define NSTRCDIS_BIT		BIT(20)
#define NASCR_CP11_BIT		BIT(11)
#define NASCR_CP10_BIT		BIT(10)

/* CPACR definitions */
#define ASEDIS_BIT			BIT(31)
#define TRCDIS_BIT			BIT(28)

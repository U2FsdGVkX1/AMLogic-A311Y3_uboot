 ...
 ********************************************************************************/
#ifdef __arm__
#define DDR_4GB						(0xffffffff)
#else
#define DDR_4GB						(1UL << 32)
#endif
#define CONFIG_DDR_TOTAL_SIZE		(DDR_4GB)			/* get from cpu reg */

/* 1. bl33z will get the DDR SIZE again from kernel REG_MDUMP_CPUBOOT_STATUS.*/
/* 2. bl33z will update the ramdump section addr with new DDR SIZE.*/
#define	CONFIG_DDR_SIZE_128MB		(0x08000000)	/* RANGE 1: 0.0M - 128M */
#define	CONFIG_DDR_SIZE_256MB		(0x10000000)	/* RANGE 1: 0.0M - 256M */
#define	CONFIG_DDR_SIZE_512MB		(0x20000000)	/* RANGE 1: 0.0M - 512M */
#define	CONFIG_DDR_SIZE_RANGE1		((DDR_4GB) - 0x20000000)	/* RANGE 1: 0.0G - 3.5G */
#define	CONFIG_DDR_SIZE_RANGE2		(DDR_4GB)		/* RANGE 2: 4.0G - 7.0G */
#define	CONFIG_DDR_SIZE_RANGE3		((DDR_4GB) + 0xC0000000)	/* RANGE 3: 7.0G - end  */

#define	CONFIG_128MB_COMPRESS_ADDR	(0x02800000)		/* 40MB for 128MB ddr */
#define	CONFIG_256MB_COMPRESS_ADDR	(0x05800000)		/* 88MB for 256MB ddr */
#define CONFIG_SMALL_COMPRESS_ADDR	(0x0c000000)		/* 192MB for 512MB ddr */
#define CONFIG_BIG_COMPRESS_ADDR	(DDR_4GB)
#define CONFIG_COMPRESS_AFTER_256MB	(0x12000000)		/* 288MB for c4 512MB ddr, bl32 is at 256MB */
...
#define CONFIG_BL31_LOAD_SIZE		(0x00200000)		/* bl31 size: 2MB */
...
#define	CONFIG_DDR_REG_SPACE_END	(DDR_4GB)		    /* ADDR: 4.0G */
#define	CONFIG_DDR_EXTEND_FLAG		((0X1C0000000)UL)	/* ADDR: 7.0G */
#define CONFIG_COMPRESSED_2_DATA_ADDR	(DDR_4GB)		/* ADDR: 4.0G, (4.0G ~ end)  */
...
#define REG_SPACE_END_ADDR			(DDR_4GB)
 ...
 * --> 0x00600000  --> stack top
 * --> 0x00620000  --> compress scrach buffer
 ...
 * --> 0x00C00000  --> mmu base ~. Reuse the storage_init region from BL2E.
 */

/* CODE space */
//#define BL33Z_RELOCATE_SELF
//#define BL33Z_C4_RUN_ADDR			0x00365000	/* run start */
#define BL33Z_LOAD_ADDR				0x00500000	/* code start */
#define BL33Z_LOAD_SIZE				0x00005000	/* 16KB code */
#define BL33Z_LIMIT					(BL33Z_LOAD_ADDR + BL33Z_LOAD_SIZE) //16KB

/* STACK space */
#define PLATFORM_STACK_BOTTOM		(PLATFORM_STACK_TOP - PLATFORM_STACK_SIZE)
#define PLATFORM_STACK_SIZE			0x00010000	/* 64KB stack size */
#define PLATFORM_STACK_TOP			0x00C00000	/* skip bl2e mmu area 0x00880000 */

/* MMU space */
#define CONFIG_AML_MMU_ADDR			(PLATFORM_STACK_TOP)
...
#define MD5_BL33Z_RAMDUMP_STR       (0x00B60000)

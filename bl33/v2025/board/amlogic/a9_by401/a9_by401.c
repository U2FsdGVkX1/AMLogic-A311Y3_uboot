...
int board_init(void)
{
	...
	i3c_devices_active(I3C_HOST_NUM);
#ifdef CONFIG_AMLOGIC_AMFC
	amfc_init();
#endif
...
int board_late_init(void)
{
	...
	edptx_driver_probe();
	//ret = uclass_get_device_by_name(UCLASS_MISC, "eDPTX0", &edptx0_dev);
	//if (ret)
	//	printf("device edptx0 not found\n");
#endif
#ifdef CONFIG_AML_LCD
...
int checkhw(char *name)
{
	...
	strcpy(dtb_name, "a9_a311y3_by401\0");

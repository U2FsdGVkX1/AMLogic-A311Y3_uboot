...
bl2_reg_t __bl2_reg[] __attribute__ ((section(".generic_param"))) = {
	/* bl32 size flag */
	/* bit0 in flag : 1: enable bl32 size  0: disable bl32 size
	 * bit1 in flag : 1: enable bl32_fastboot_256m 0: disable bl32_fastboot_256m
	 * bit2 in flag : 1: enable bl32_fastboot_128m 0: disable bl32_fastboot_128m
	 */
	{0, 16991, 0xffffffff, 0, BL32_CONFIG, 0},
	/* value is bl22 size */
	...
	/* bit3 in flag, 1: support fastboot & firmware header, 0: no fastboot */
...
__attribute__ ((section(".misc_param"))) = {
	...
	{ PADCTRL_PIN_MUX_REG9,	   (0x11), 0xff, 0, 0, 0 },
	{ PADCTRL_GPIOD_PULL_UP,   (0x1 << 2),	  (0x1 << 2), 0, 0, 0 },
	{ PWM_OPEN_A,	   (0x1 << 0),	  (0x1 << 0), 0, 0, 0 },
	{ PWM_OPEN_B,	   (0x1 << 0),	  (0x1 << 0), 0, 0, 0 },
	{ PWM_OPEN_D,	   (0x1 << 0),	  (0x1 << 0), 0, 0, 0 },
...
storage_parameter_t __store_para __section(".store_param") = {
	.common				= {
		...
		.bl3_ree_container_size = 0,
		.bl3_tee_container_size = 0,
	},
	.nand				= {
		.version = 0x01,

...
#define DDR_FUNC_CONFIG_ENABLE_RX_SOC_VREF_AVERAGE                  (0 + (1 << 14))
...
#define DDR_ID_FROM_ADC_MULT_F   (0Xfc000000)
#define DDR_ID_FROM_ADC_MULT_F_LPDDR5 (0Xfb000000)
#define DDR_ID_FROM_ADC_MULT_F_LPDDR4X (0Xfa000000)
#define DDR_ID_FROM_ADC_MULT_F_LPDDR2 (0Xf9000000)
#define DDR_ID_FROM_ADC_MULT_F_LPDDR3 (0Xf8000000)
#define DDR_ID_FROM_ADC_MULT_F_LPDDR4 (0Xf7000000)
#define DDR_ID_FROM_ADC_MULT_F_DDR4 (0Xf6000000)
#define DDR_ID_FROM_ADC_MULT_F_DDR3 (0Xf5000000)
#define DDR_ID_SET_DDRID_TO_SPEED_TABLE_PRE_LP5 (0Xf1000000)
#define DDR_ID_SET_DDRID_TO_SPEED_TABLE_PRE_LP4 (0Xf0000000)
//#define DDR_ID_SET_DDRID_TO_SPEED_TABLE (0Xf0000000)
...
#define SPEED_3733_INDEX 1
#define SPEED_4032_INDEX 2
#define SPEED_4266_INDEX 3
#define SPEED_4800_INDEX 4
#define SPEED_RESERVE_INDEX 5 //just for reserve

#define SPEED_3733  77 //(3733 / 48)
#define SPEED_4032  84 //(4032 / 48)
#define SPEED_4266  88 //(4266 / 48)
#define SPEED_4800 100 //(4800 / 48)
#define SPEED_4032_X5_3733_X5L  84 //(4032 / 48)
#define SPEED_4266_X5_4032_X5L  88 //(4266 / 48)

#define SPEED_LP4_3733_X5  77 //(3733 / 48)
#define SPEED_LP4_4032_X5  84 //(4032 / 48)
#define SPEED_LP4_4266_X5  88 //(4266 / 48)

#define SPEED_LP4_3733_X5L  84 //(4032 / 48)
#define SPEED_LP4_4032_X5L  88 //(4266 / 48)

#define SPEED_LP5_3733_X5  77 //(3733 / 48)
#define SPEED_LP5_4032_X5  84 //(4032 / 48)
#define SPEED_LP5_4266_X5  88 //(4266 / 48)

#define SPEED_LP5_3733_X5L  84 //(4032 / 48)
#define SPEED_LP5_4032_X5L  88 //(4266 / 48)
#define SPEED_LP4_3733  77 //(3733 / 48)
#define SPEED_LP5_4032  84 //(4032 / 48)
#define SPEED_LP5_4266  88 //(4266 / 48)
#define SPEED_LP5_4800 100 //(4800 / 48)

#define SPEED_RESERVE (9999 / 48) //just for test, special value,do not modify

#define CHIP_S905X5 1
#define CHIP_S905X5L 5

#define CHIP_S905X5_LPDDR4 1
#define CHIP_S905X5_LPDDR5 2
#define CHIP_S905X5L_LPDDR4 3
#define CHIP_S905X5L_LPDDR5 4
...
#define DDR_ID_SET_DDRID_TO_SPEED_TABLE_LP4(speed, ch0, ch1, ch2, ch3) (ch0) |\
((ch1) << 4) | ((ch2) << 8) | ((ch3) << 12) | (speed << 16) |\
(DDR_ID_SET_DDRID_TO_SPEED_TABLE_PRE_LP4)
#define DDR_ID_SET_DDRID_TO_SPEED_TABLE_LP5(speed, ch0, ch1, ch2, ch3) (ch0) |\
((ch1) << 4) | ((ch2) << 8) | ((ch3) << 12) | (speed << 16) |\
(DDR_ID_SET_DDRID_TO_SPEED_TABLE_PRE_LP5)
...
#if LPDDR5_SKT
#define  CACLU_CLK_LP5   792 //freq will be limit by ddr id speed bin
//ddr_set_ps0_only_t __attribute__ ((aligned(8))) ddr_set_t_default_lp5 = {
	{
		...
		.cfg_board_common_setting.timming_struct_version = 9483,
		...
		DDR_FUNC_CONFIG_ENABLE_RX_SOC_VREF_AVERAGE,
		...
		//	(DRAM_SIZE_ID_512MBX0 << CONFIG_CS1_BYTE_01_SIZE_512_ID_OFFSET) +
		//	(DRAM_SIZE_ID_512MBX0 << CONFIG_CS1_BYTE_23_SIZE_512_ID_OFFSET),
		.cfg_board_common_setting.rsv_char0 = 0,//use for VDDDDR training voltage offset
		...
		.cfg_board_SI_setting_ps.dram_data_odt_ohm = 0,
		.cfg_board_SI_setting_ps.dram_data_wr_odt_ohm = 60,
		...
		.cfg_ddr_training_delay_ps.ac_trace_delay[0] = 128 - 0, //0-11 cha,12-23 chb
		.cfg_ddr_training_delay_ps.ac_trace_delay[1] = 128 - 0,//max511 1trip=2wckUI =1Twck
		.cfg_ddr_training_delay_ps.ac_trace_delay[2] = 128 - 0,
		.cfg_ddr_training_delay_ps.ac_trace_delay[3] = 128 - 0,
		.cfg_ddr_training_delay_ps.ac_trace_delay[4] = 128 - 0,
		.cfg_ddr_training_delay_ps.ac_trace_delay[5] = 128 - 0,
		.cfg_ddr_training_delay_ps.ac_trace_delay[6] = 128 - 0,
		.cfg_ddr_training_delay_ps.ac_trace_delay[7] = 128 - 0,
		.cfg_ddr_training_delay_ps.ac_trace_delay[8] = 128 - 0,
		.cfg_ddr_training_delay_ps.ac_trace_delay[9] = 128 - 0,
		.cfg_ddr_training_delay_ps.ac_trace_delay[10] = 128,
		.cfg_ddr_training_delay_ps.ac_trace_delay[11] = 128,
		.cfg_ddr_training_delay_ps.ac_trace_delay[12] = 128 - 0,
		.cfg_ddr_training_delay_ps.ac_trace_delay[13] = 128 - 0,
		.cfg_ddr_training_delay_ps.ac_trace_delay[14] = 128 + 0,
		.cfg_ddr_training_delay_ps.ac_trace_delay[15] = 128 - 0,
		.cfg_ddr_training_delay_ps.ac_trace_delay[16] = 128 - 0,
		.cfg_ddr_training_delay_ps.ac_trace_delay[17] = 128 - 0,
		.cfg_ddr_training_delay_ps.ac_trace_delay[18] = 128 - 0,
		.cfg_ddr_training_delay_ps.ac_trace_delay[19] = 128 - 0,
		.cfg_ddr_training_delay_ps.ac_trace_delay[20] = 128 - 0,
		.cfg_ddr_training_delay_ps.ac_trace_delay[21] = 128 - 0,
...
#endif
#if LPDDR4_SKT
#define  CACLU_CLK_LP4   2112 //freq will be limited by ddr id speed bin
//ddr_set_ps0_only_t __attribute__ ((aligned(8))) ddr_set_t_default_lp4 = {
	{
		...
		//2 auto 4x use nn 4 use pn drivere
		//3 auto + force 4 4x both use nn driver
		.cfg_board_common_setting.rsv_char0 = 20,//use for VDDDDR training voltage offset
		.cfg_board_common_setting.dram_rank_config = CONFIG_DDR0_32BIT_RANK0_CH0,
		...
		.cfg_board_SI_setting_ps.dram_ac_odt_ohm = 0,//240,//use 0 for cxmt 8die DRAM
		.cfg_board_SI_setting_ps.dram_drv_pull_up_cal_ohm =
			DDR_DRAM_LPDDR4_ODT_40_OHM,
		.cfg_board_SI_setting_ps.lpddr4_dram_vout_range =
			1,//DDR_DRAM_LPDDR4_OUTPUT_1_3_VDDQ,

...
bl2_reg_t __bl2_reg[] __attribute__ ((section(".generic_param"))) = {
	...
	/* bit1 in flag, 1: support AB boot, 0: no AB */
	/* bit2 in flag, 1: support Recovery boot, 0: no Recovery */
	{ 0, 16992, 0xffffffff, 0, BL2_CONFIG, 0 },
};
...
__attribute__ ((section(".misc_param"))) = {
	...
	{ PWM_PWM_C, VDDEE_SS_VALUE, 0xffffffff, 0, BL2_INIT_STAGE_VDDCORE_CONFIG_1, 0 },
	{ PWM_PWM_C, VDDEE_TT_VALUE, 0xffffffff, 0, BL2_INIT_STAGE_VDDCORE_CONFIG_2, 0 },
	{ PWM_PWM_C, VDDEE_FF_VALUE, 0xffffffff, 0, BL2_INIT_STAGE_VDDCORE_CONFIG_3, 0 },
#else
	{ PWM_PWM_C,		   VDDEE_VAL_REG, 0xffffffff, 0, 0, 0},
#endif
	{ PWM_PWM_E,		   VDDDDR_VAL_REG, 0xffffffff, 0, 0, 0},
	...
	{ PWM_PWM_D,		   VCCK_VAL_REG,  0xffffffff, 0, 0, 0 },
	{ PWM_MISC_REG_C,	   (0x1 << 0),	  (0x1 << 0), 0, 0, 0 },
	{ PWM_MISC_REG_D,	   (0x1 << 0),	  (0x1 << 0), 0, 0, 0 },
	{ PWM_MISC_REG_E,	   (0x1 << 0),	  (0x1 << 0), 0, 0, 0 },
	/* set pwm c ,pwmd and pwm e clock rate to 24M, enable them */
	{ CLKCTRL_PWM_CLK_C_CTRL, (0x1 << 8), 0xffffffff, 0, 0, 0 },
	{ CLKCTRL_PWM_CLK_D_CTRL, (0x1 << 8), 0xffffffff, 0, 0, 0 },
	{ CLKCTRL_PWM_CLK_E_CTRL, (0x1 << 8), 0xffffffff, 0, 0, 0 },
	/* set GPIOE_0 GPIOE_1  GPIOE_2 mux to pwmc pwmd pwme */
	{ PADCTRL_PIN_MUX_REG8,	   (0x111), 0x000000fff, 0, 0, 0 },
#ifdef CONFIG_NOVERBOSE_BUILD
	{ UART_B_WFIFO, 0, 0xffffffff, 0, 1, 0 },
#endif
};

partition_info_t __partition_info_t[MAX_PART_COUNT]
__attribute__ ((section(".store_partition"))) = {
	/* partname & partsize unit 4kB */
	{"data1", 16},
};
...
storage_parameter_t __store_para __section(".store_param") = {
	.common				= {
		...
		.bl3_ree_container_size = CONFIG_BL3_REE_SIZE,
		.bl3_tee_container_size = CONFIG_BL3_TEE_SIZE,
	},
	.nand				= {
		.version = 0x01,

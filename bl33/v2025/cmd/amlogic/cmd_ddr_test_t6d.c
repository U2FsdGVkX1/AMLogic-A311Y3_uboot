...
#define AM_DDR_FREQ_CTRL                           ((0x000a  << 2) + 0xfe036c00)
  ...
  //bit 30     current FREQ selection.  it can forced to change to select which frequency to select, or it can auto changed by FREQ change hardware.
  ...
  //bit 9:8. pll_reserve in frequency1. pll_reserve[5:4] used to tune 2 DMC channel clock phase.

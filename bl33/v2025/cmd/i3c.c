...
static struct i3c_master_controller *master;
#else
...
#if (IS_ENABLED(CONFIG_AMLOGIC_MODIFY))
	int i = (u32)simple_strtoul(name, NULL, 10);
	int ret = uclass_get_device_by_seq(UCLASS_I3C, i, &currdev);
#else

...
#include <asm/amlogic/arch-x1/clock.h>
#include <asm/io.h>
...
/* change it later */
#define SYS_CLK		166666667

static unsigned int saradc_parents[] = {CLKID_XTAL, CLKID_SYS_CLK};

static unsigned int spisg_parents[] = {CLKID_XTAL, CLKID_SYS_CLK,
	CLKID_FCLK_DIV4, CLKID_FCLK_DIV3, CLKID_FCLK_DIV2,
	CLKID_FCLK_DIV5, CLKID_FCLK_DIV7, CLKID_GP0_PLL};
...
static struct meson_mux muxes[] = {
	{CLKID_SARADC_MUX, X1_CLKCTRL_SAR_CLK_CTRL0, 9, 0x3, saradc_parents, ARRAY_SIZE(saradc_parents)},
	{CLKID_SPISG0_MUX, X1_CLKCTRL_SPISG_CLK_CTRL, 7,  0x7, spisg_parents, ARRAY_SIZE(spisg_parents)},
	{CLKID_SPISG1_MUX, X1_CLKCTRL_SPISG_CLK_CTRL, 23,  0x7, spisg_parents, ARRAY_SIZE(spisg_parents)},
	{CLKID_SD_EMMC_C_MUX, X1_CLKCTRL_NAND_CLK_CTRL, 9, 0x7, sd_emmc_parents, ARRAY_SIZE(sd_emmc_parents)}
};

static struct meson_div divs[] = {
	{CLKID_SARADC_DIV, X1_CLKCTRL_SAR_CLK_CTRL0, 0, 8, CLKID_SARADC_MUX},
	{CLKID_SPISG0_DIV, X1_CLKCTRL_SPISG_CLK_CTRL, 0, 6, CLKID_SPISG0_MUX},
	{CLKID_SPISG1_DIV, X1_CLKCTRL_SPISG_CLK_CTRL, 16, 6, CLKID_SPISG0_MUX},
	{CLKID_SD_EMMC_C_DIV, X1_CLKCTRL_NAND_CLK_CTRL, 0, 7, CLKID_SD_EMMC_C_MUX}
};

static struct meson_gate gates[] = {
	{CLKID_SARADC, X1_CLKCTRL_SAR_CLK_CTRL0, 8},
	{CLKID_SPISG0, X1_CLKCTRL_SPISG_CLK_CTRL, 6},
	{CLKID_SPISG1, X1_CLKCTRL_SPISG_CLK_CTRL, 22},
	{CLKID_SD_EMMC_C, X1_CLKCTRL_NAND_CLK_CTRL, 7}
};

static struct parm meson_fixed_pll_parm[3] = {
	{X1_ANACTRL_FIXPLL_CTRL0, 0, 9}, /* pm */
	{X1_ANACTRL_FIXPLL_CTRL0, 10, 5}, /* pn */
	{X1_ANACTRL_FIXPLL_CTRL0, 16, 2}, /* pod */
};

static struct parm meson_gp0_pll_parm[4] = {
	{X1_ANACTRL_GP0PLL_CTRL0, 0, 9}, /* pm */
	{X1_ANACTRL_GP0PLL_CTRL0, 16, 2}, /* pn */
	{X1_ANACTRL_GP0PLL_CTRL0, 12, 2}, /* pod */
	{X1_ANACTRL_GP0PLL_CTRL3, 0, 17}, /* pfrac */
};

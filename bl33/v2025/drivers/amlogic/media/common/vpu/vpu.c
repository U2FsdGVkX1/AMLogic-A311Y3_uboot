...
/* v20230801: add s7 support */
/* v20250407: add a9 support */

#define VPU_VERSION "v20250902"
...
static struct vpu_data_s vpu_data_s6 = {
	.chip_type = VPU_CHIP_S6,
	.chip_name = "s6",
	.clk_level_dft = CLK_LEVEL_DFT_G12A,
	.clk_level_max = CLK_LEVEL_MAX_G12A,
	.gp_pll_valid = 0,
...
static struct vpu_data_s vpu_data_t6w = {
	...
	.fclk_div_table = fclk_div_table_t6w,
	.vpu_clk_table = vpu_clk_table_t6w,
	.test_reg = vcbus_test_reg,
...
static struct vpu_data_s vpu_data_a9 = {
	.chip_type = VPU_CHIP_A9,
	.chip_name = "a9",
	.clk_level_dft = CLK_LEVEL_DFT_G12A,
	.clk_level_max = CLK_LEVEL_MAX_G12A,
	.gp_pll_valid = 0,
...
static void vpu_chip_detect(void)
{
	...
	case MESON_CPU_MAJOR_ID_T6W:
		vpu_conf.data = &vpu_data_t6w;
		break;
	case MESON_CPU_MAJOR_ID_A9:
		vpu_conf.data = &vpu_data_a9;
		break;
	default:
		vpu_conf.data = NULL;
		//vpu_conf.data = &vpu_data_t3;

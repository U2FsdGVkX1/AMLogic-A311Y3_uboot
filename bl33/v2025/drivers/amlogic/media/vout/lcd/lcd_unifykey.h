...
/* 4 channel pwm (96byte)*/
#define LCD_UKEY_BL_PWM_ARRAY0_METHOD    (LCD_UKEY_BL_NAME + 108)
#define LCD_UKEY_BL_PWM_ARRAY0_PORT      (LCD_UKEY_BL_NAME + 109)
#define LCD_UKEY_BL_PWM_ARRAY0_FREQ      (LCD_UKEY_BL_NAME + 110)
#define LCD_UKEY_BL_PWM_ARRAY0_DUTY_MAX  (LCD_UKEY_BL_NAME + 114)
#define LCD_UKEY_BL_PWM_ARRAY0_DUTY_MIN  (LCD_UKEY_BL_NAME + 118)
#define LCD_UKEY_BL_PWM_ARRAY0_GPIO      (LCD_UKEY_BL_NAME + 122)
#define LCD_UKEY_BL_PWM_ARRAY0_GPIO_OFF  (LCD_UKEY_BL_NAME + 123)
#define LCD_UKEY_BL_PWM_ARRAY0_LEVEL_MAX (LCD_UKEY_BL_NAME + 124)
#define LCD_UKEY_BL_PWM_ARRAY0_LEVEL_MIN (LCD_UKEY_BL_NAME + 128) // 132 - 108 = 24

#define LCD_UKEY_BL_PWM_ARRAY1_METHOD    (LCD_UKEY_BL_NAME + 132)
#define LCD_UKEY_BL_PWM_ARRAY1_PORT      (LCD_UKEY_BL_NAME + 133)
#define LCD_UKEY_BL_PWM_ARRAY1_FREQ      (LCD_UKEY_BL_NAME + 134)
#define LCD_UKEY_BL_PWM_ARRAY1_DUTY_MAX  (LCD_UKEY_BL_NAME + 138)
#define LCD_UKEY_BL_PWM_ARRAY1_DUTY_MIN  (LCD_UKEY_BL_NAME + 142)
#define LCD_UKEY_BL_PWM_ARRAY1_GPIO      (LCD_UKEY_BL_NAME + 146)
#define LCD_UKEY_BL_PWM_ARRAY1_GPIO_OFF  (LCD_UKEY_BL_NAME + 147)
#define LCD_UKEY_BL_PWM_ARRAY1_LEVEL_MAX (LCD_UKEY_BL_NAME + 148)
#define LCD_UKEY_BL_PWM_ARRAY1_LEVEL_MIN (LCD_UKEY_BL_NAME + 152) // 156 - 132 = 24

#define LCD_UKEY_BL_PWM_ARRAY2_METHOD    (LCD_UKEY_BL_NAME + 156)
#define LCD_UKEY_BL_PWM_ARRAY2_PORT      (LCD_UKEY_BL_NAME + 157)
#define LCD_UKEY_BL_PWM_ARRAY2_FREQ      (LCD_UKEY_BL_NAME + 158)
#define LCD_UKEY_BL_PWM_ARRAY2_DUTY_MAX  (LCD_UKEY_BL_NAME + 162)
#define LCD_UKEY_BL_PWM_ARRAY2_DUTY_MIN  (LCD_UKEY_BL_NAME + 166)
#define LCD_UKEY_BL_PWM_ARRAY2_GPIO      (LCD_UKEY_BL_NAME + 170)
#define LCD_UKEY_BL_PWM_ARRAY2_GPIO_OFF  (LCD_UKEY_BL_NAME + 171)
#define LCD_UKEY_BL_PWM_ARRAY2_LEVEL_MAX (LCD_UKEY_BL_NAME + 172)
#define LCD_UKEY_BL_PWM_ARRAY2_LEVEL_MIN (LCD_UKEY_BL_NAME + 176) // 180 - 156 = 24

#define LCD_UKEY_BL_PWM_ARRAY3_METHOD    (LCD_UKEY_BL_NAME + 180)
#define LCD_UKEY_BL_PWM_ARRAY3_PORT      (LCD_UKEY_BL_NAME + 181)
#define LCD_UKEY_BL_PWM_ARRAY3_FREQ      (LCD_UKEY_BL_NAME + 182)
#define LCD_UKEY_BL_PWM_ARRAY3_DUTY_MAX  (LCD_UKEY_BL_NAME + 186)
#define LCD_UKEY_BL_PWM_ARRAY3_DUTY_MIN  (LCD_UKEY_BL_NAME + 190)
#define LCD_UKEY_BL_PWM_ARRAY3_GPIO      (LCD_UKEY_BL_NAME + 194)
#define LCD_UKEY_BL_PWM_ARRAY3_GPIO_OFF  (LCD_UKEY_BL_NAME + 195)
#define LCD_UKEY_BL_PWM_ARRAY3_LEVEL_MAX (LCD_UKEY_BL_NAME + 196)
#define LCD_UKEY_BL_PWM_ARRAY3_LEVEL_MIN (LCD_UKEY_BL_NAME + 200) // 204 - 180 = 24
...
int lcd_unifykey_write_force(const char *key_name, unsigned char *buf, int len);

 ...
 */
static const struct tx_timing edid_cea_modes_0[] = {
	...
	{HDMI_2_720x480p60_4x3, "720x480p60hz", "480p60hz", 1, 31469, 59940, 27027,
		858, 138, 16, 62, 60, 720, 525, 45, 9, 6, 30, 480, 7, 0, 0, 4, 3, 8, 9},
	{HDMI_3_720x480p60_16x9, "720x480p60hz", "480p60hz", 1, 31469, 59940, 27027,
	...
	{HDMI_5_1920x1080i60_16x9, "1920x1080i60hz", "1080i60hz", 0, 33750, 60000, 74250,
		2200, 280, 88, 44, 148, 1920, 1125, 22, 4, 10, 8, 1080, 1, 1, 1, 16, 9, 1, 1},
	{HDMI_6_720x480i60_4x3, "720x480i60hz", "480i60hz", 0, 15734, 59940, 27027,
		1716, 276, 38, 124, 114, 1440, 525, 22, 8, 6, 8, 480, 4, 0, 0, 4, 3, 8, 9, 1},
	{HDMI_7_720x480i60_16x9, "720x480i60hz", "480i60hz", 0, 15734, 59940, 27027,
		1716, 276, 38, 124, 114, 1440, 525, 22, 8, 6, 8, 480, 4, 0, 0, 16, 9, 32, 27, 1},
	...
	{HDMI_10_2880x480i60_4x3, "2880x480i60hz", NULL, 0, 15734, 59940, 54000,
		3432, 552, 76, 248, 228, 2880, 525, 22, 8, 6, 8, 480, 4, 0, 0, 4, 3, 2, 9},
	{HDMI_11_2880x480i60_16x9, "2880x480i60hz", NULL, 0, 15734, 59940, 54000,
		3432, 552, 76, 248, 228, 2880, 525, 22, 8, 6, 8, 480, 4, 0, 0, 16, 9, 8, 27},
	...
	{HDMI_20_1920x1080i50_16x9, "1920x1080i50hz", "1080i50hz", 0, 28125, 50000, 74250,
		2640, 720, 528, 44, 148, 1920, 1125, 22, 4, 10, 8, 1080, 1, 1, 1, 16, 9, 1, 1},
	{HDMI_21_720x576i50_4x3, "720x576i50hz", "576i50hz", 0, 15625, 50000, 27000,
		1728, 288, 24, 126, 138, 1440, 625, 24, 4, 6, 14, 576, 1, 0, 0, 4, 3, 16, 15, 1},
	{HDMI_22_720x576i50_16x9, "720x576i50hz", "576i50hz", 0, 15625, 50000, 27000,
		1728, 288, 24, 126, 138, 1440, 625, 24, 4, 6, 14, 576, 1, 0, 0, 16, 9, 64, 65, 1},
	...
	{HDMI_25_2880x576i50_4x3, "2880x576i50hz", NULL, 0, 15625, 50000, 54000,
		3456, 576, 48, 252, 276, 2880, 625, 24, 4, 6, 14, 576, 1, 0, 0, 4, 3, 2, 15},
	{HDMI_26_2880x576i50_16x9, "2880x576i50hz", NULL, 0, 15625, 50000, 54000,
		3456, 576, 48, 252, 276, 2880, 625, 24, 4, 6, 14, 576, 1, 0, 0, 16, 9, 16, 45},
	...
	{HDMI_39_1920x1080i_t1250_50_16x9, "1920x1080i50hz", NULL, 0, 31250, 50000, 72000,
		2304, 384, 32, 168, 184, 1920, 1250, 85, 46, 10, 29, 1080, 1, 1, 0, 16, 9, 1, 1},
	...
	{HDMI_44_720x576i100_4x3, "720x576i100hz", NULL, 0, 31250, 100000, 54000,
		1728, 288, 24, 126, 138, 1440, 625, 24, 4, 6, 14, 576, 1, 0, 0, 4, 3, 16, 15},
	{HDMI_45_720x576i100_16x9, "720x576i100hz", NULL, 0, 31250, 100000, 54000,
		1728, 288, 24, 126, 138, 1440, 625, 24, 4, 6, 14, 576, 1, 0, 0, 16, 9, 64, 45},
	...
	{HDMI_50_720x480i120_4x3, "720x480i120hz", NULL, 0, 31469, 119880, 54000,
		1716, 276, 38, 124, 114, 1440, 525, 22, 8, 6, 8, 480, 4, 0, 0, 4, 3, 8, 9},
	{HDMI_51_720x480i120_16x9, "720x480i120hz", NULL, 0, 31469, 119880, 54000,
		1716, 276, 38, 124, 114, 1440, 525, 22, 8, 6, 8, 480, 4, 0, 0, 16, 9, 32, 27},
...
static const struct tx_timing edid_cea_modes_193[] = {
 ...
 */
static const struct tx_timing vesa_modes[] = {
...
/*always return valid struct tx_timing, for invalid vic, return timing with vic=1.*/
const struct tx_timing *meson_tx_mode_vic_to_timing(enum hdmi_vic vic)
{
	...
	struct {
		enum hdmi_vic start;
		enum hdmi_vic end;
		const struct tx_timing *timing_start;
	} all_timing_list[] = {
...
/* EXPORT_SYMBOL(meson_tx_mode_vic_to_timing); */
...
const struct tx_timing *meson_tx_mode_match_dtd_timing(struct dtd *t)
{
	...
	while (1) {
		timing = meson_tx_mode_index_to_timing(i);
		if (!timing)
			break;
...
bool meson_tx_mode_compare(struct tx_timing *t1, struct tx_timing *t2)
{
	...
	/* pixel freq difference threshold 1Mhz */
	if ((abs(t2->pixel_freq - t1->pixel_freq) <= 1000) &&
		t1->h_total == t2->h_total &&
		t1->h_active == t2->h_active &&
		t1->h_blank == t2->h_blank &&
		t1->h_front == t2->h_front &&
		t1->h_sync == t2->h_sync &&
		t1->v_total == t2->v_total &&
		t1->v_active == t2->v_active &&
		t1->v_blank == t2->v_blank &&
		t1->v_front == t2->v_front &&
		t1->v_sync == t2->v_sync &&
		t1->h_pol == t2->h_pol &&
		t1->v_pol == t2->v_pol &&
		t1->pi_mode == t2->pi_mode)
		ret = true;
...
const struct tx_timing *meson_tx_match_detail_timing(struct tx_timing *t)
{
	...
	while (1) {
		...
		/* pixel freq difference threshold 1Mhz */
		if (meson_tx_mode_compare(t, (struct tx_timing *)timing))
			return timing;
...
const struct tx_timing *meson_tx_mode_match_vesa_timing(struct vesa_standard_timing *t)
{
	...
	for (i = 0; i < ARRAY_SIZE(vesa_modes); i++) {
		...
		if (t->hactive == timing->h_active &&
			...
			if (t->vsync) {
				unsigned int vsync =
					DIV_ROUND_CLOSEST_ULL(meson_tx_get_timing_vrefresh(timing),
						1000);
...
{
	return DIV_ROUND_CLOSEST_ULL(mul_u32_u32(1000, 1000000), t->v_freq);
}

static bool meson_tx_mode_have_alternate_clock(const struct tx_timing *t)
{
	/*to be confirm if VESA can support frac rate.*/
	if (t->vic == HDMI_0_UNKNOWN || t->vic >= HDMI_CEA_VIC_END)
		return false;

	if (meson_tx_get_timing_vrefresh(t) % 6 != 0)
		return false;
...
int meson_tx_mode_update_timing(struct tx_timing *t,
	bool to_frac_mode)
{
	unsigned int alternate_clock = 0;
	bool frac_timing = t->v_freq % 1000 == 0 ? false : true;

	if (!meson_tx_mode_have_alternate_clock(t))
		return -EINVAL;
...
void meson_tx_mode_print_timing(const struct tx_timing *t)
{
	struct tx_timing alternate_t;

	pr_info("VIC Hactive Vactive I/P Htotal Hblank Vtotal Vblank Hfreq Vfreq Pfreq\n");
	pr_info("%s[%d] %d %d %c %d %d %d %d %d %d %d\n",
		t->name, t->vic,
	...
	if (meson_tx_mode_have_alternate_clock(t)) {
		alternate_t = *t;
		if (meson_tx_mode_update_timing(&alternate_t, 0) > 0 ||
			meson_tx_mode_update_timing(&alternate_t, 1) > 0) {
...
void meson_tx_mode_print_all_mode_table(void)
{
	...
	do {
		timing = meson_tx_mode_index_to_timing(idx);
		if (!timing)
			break;

		meson_tx_mode_print_timing(timing);
	} while (++idx);

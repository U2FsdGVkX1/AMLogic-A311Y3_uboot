...
static int xhci_dwc3_setup_phy(struct udevice *dev, struct phy_bulk *phys)
{
    int ret;
...
static int xhci_dwc3_probe(struct udevice *dev)
{
	...
	ret = xhci_dwc3_setup_phy(dev, &plat->usb_phys);
	if (ret)
		return ret;
...
int dwc3_meson_shutdown_phy(struct udevice *dev, struct phy_bulk *phys)
{
	int ret;
...
static int xhci_dwc3_remove(struct udevice *dev)
{
	...
	dwc3_meson_shutdown_phy(dev, &plat->usb_phys);

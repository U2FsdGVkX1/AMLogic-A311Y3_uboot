...
#define V3_GPT_LOAD_ADDR        (V3_DTB_LOAD_ADDR + 0x100000)
#define V3_PAYLOAD_LOAD_ADDR    (V3_GPT_LOAD_ADDR + 0x180000) //sheader for sc2 nand
 ...
 *@errInfo: start it with success if burned ok, or format error info into it tell pc burned failed
 */
unsigned v2_key_burn(const char *keyName, const u8 *keyVal, const u32 keyValLen, char *errInfo);

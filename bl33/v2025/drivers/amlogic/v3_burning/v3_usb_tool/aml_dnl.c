 ...
 */
#undef CFG_USB_GADGET_VENDOR_NUM
#undef CFG_USB_GADGET_PRODUCT_NUM
#undef CFG_USB_GADGET_MANUFACTURER
#define CFG_USB_GADGET_VENDOR_NUM 0x1b8e
#define CFG_USB_GADGET_PRODUCT_NUM 0xc004
#define CFG_USB_GADGET_MANUFACTURER  "Amlogic Inc"
...
static const char manufacturer[] = CFG_USB_GADGET_MANUFACTURER;
...
static struct usb_device_descriptor device_desc = {
	...
	.idVendor = cpu_to_le16(CFG_USB_GADGET_VENDOR_NUM),
	.idProduct = cpu_to_le16(CFG_USB_GADGET_PRODUCT_NUM),
	/* .iProduct = DYNAMIC */

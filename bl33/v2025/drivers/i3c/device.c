...
struct i3c_device * dm_get_i3c_dev(struct udevice *dev)
{
	return (struct i3c_device *)dev_get_parent_plat(dev);
}
EXPORT_SYMBOL_GPL(dm_get_i3c_dev);
#endif

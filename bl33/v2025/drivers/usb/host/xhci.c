...
#else
static inline void xhci_init_descriptor(struct descriptor *descriptor)
{
...
#else
	ctrl->hub_desc = ctrl->descriptor.hub;
#endif
...
#ifdef CONFIG_AMLOGIC_USB
	memset(&ctrl->descriptor, 0x00, sizeof(struct descriptor));

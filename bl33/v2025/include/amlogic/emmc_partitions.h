...
#include <amlogic/emmc_storage.h>
...
/* reserved partition config */
#define MMC_RESERVED_NAME			"reserved"
#ifdef CONFIG_AMLOGIC_MIN_RESERVED_PARTITION
#define PARTITION_RESERVED			(0 * SZ_1M)
#define PARTITION_MIN_RESERVED			0
#define MMC_BOOT_PARTITION_RESERVED		(0 * SZ_1M)
#define RESERVED_GPT_OFFSET			(4 * SZ_1M)
#define MMC_RESERVED_SIZE			(2 * SZ_1M)
#else
#define PARTITION_RESERVED			(8 * SZ_1M)
#define PARTITION_MIN_RESERVED			SZ_1M
#define MMC_BOOT_PARTITION_RESERVED		(32 * SZ_1M)
#define RESERVED_GPT_OFFSET			(36 * SZ_1M)
#define MMC_RESERVED_SIZE			(64 * SZ_1M)
#endif	/* CONFIG_AMLOGIC_MIN_RESERVED_PARTITION */
...
/* reserved partition table */
/* <----table----> */
#define MMC_TABLE_NAME				("AML_TABLE")
#define MMC_TABLE_OFFSET			(0x0)
#define MMC_TABLE_SIZE				(16 * SZ_1K)
/* <----key----> */
#define MMC_KEY_NAME				"key"
#define EMMCKEY_RESERVE_OFFSET			(16 * SZ_1K)
#define MMC_KEY_SIZE				(256 * SZ_1K)
#define KEY_BACKUP
#define KEY_COPIES				(2)
/* <----pattern----> */
#define	MMC_PATTERN_NAME			"pattern"
#ifdef CONFIG_AMLOGIC_MIN_RESERVED_PARTITION
#define CALI_PATTERN_OFFSET			(528 * SZ_1K)
#else
...
#ifdef CONFIG_AMLOGIC_MIN_RESERVED_PARTITION
#define RANDOM_OFFSET				(784 * SZ_1K)
#else
...
#ifdef CONFIG_AMLOGIC_MIN_RESERVED_PARTITION
#define DDR_PARAMETER_OFFSET			(1424 * SZ_1K)
#else

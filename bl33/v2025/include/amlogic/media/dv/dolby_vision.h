...
extern unsigned int  dv_read_reg(unsigned int addr);
extern void dv_write_reg(unsigned int addr, unsigned int value);
extern void dolby_vision_process(void);
extern void send_hdmi_pkt(void);
extern int apply_stb_core_settings(void);
extern void dolbyvision_dump_setting(void);
extern void dolbyvision_debug(int enable_debug);
#else
...
unsigned int __attribute__((weak)) dv_read_reg(unsigned int addr)
{
	return 0;
}
void __attribute__((weak)) dv_write_reg(unsigned int addr, unsigned int value)
{
	return;
}
void __attribute__((weak)) dolby_vision_process(void)
{
	return;
}
void __attribute__((weak)) send_hdmi_pkt(void)
{
	return;
}
int __attribute__((weak)) apply_stb_core_settings(void)
{
	return 0;
}
void __attribute__((weak)) dolbyvision_dump_setting(void)
{
	return;
}
void __attribute__((weak)) dolbyvision_debug(int enable_debug)
{
	return;
}
#endif

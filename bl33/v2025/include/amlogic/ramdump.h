...
extern int g_ramdump_skip_osd_lcd;
...
/* ramdump clean ddr */
#define RAMDUMP_SKIP_BL31_START     (0x05000000)
#define RAMDUMP_SKIP_BL32_END       (0x08400000)
#define RAMDUMP_COMPRESS_START      (0x0C000000)
#define RAMDUMP_ISOLATION_SIZE      (0x01000000)

...
struct andr_vnd_boot_img_hdr {
	...
	unsigned char szReserved[ANDR_GKI_PAGE_SIZE - 2128];
#endif
};
...
#define LOAD_ADDR_ALIGN_LENGTH      0x200000

#define BOOT_IMG_HDR_SIZE         (0x800)
#define BOOT_IMG_V3_HDR_SIZE      (0x1000)
#define VENDOR_BOOT_IMG_HDR_SIZE  (0x1000)

typedef struct andr_boot_img_hdr_v3 boot_img_hdr_v3_t;
typedef struct andr_boot_img_hdr_v3 *p_boot_img_hdr_v3_t;

typedef struct andr_boot_img_hdr_v0 boot_img_hdr_t;
typedef struct andr_boot_img_hdr_v0 *p_boot_img_hdr_t;

typedef struct andr_vnd_boot_img_hdr vendor_boot_img_hdr_t;
typedef struct andr_vnd_boot_img_hdr *p_vendor_boot_img_hdr_t;
...
struct vendor_boot_img {
    vendor_boot_img_hdr_t hdr;
    unsigned char         szData[1];
};

typedef struct vendor_boot_img vendor_boot_img_t;
typedef struct vendor_boot_img *p_vendor_boot_img_t;

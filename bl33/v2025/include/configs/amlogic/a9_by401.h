 ...
 */
#define AML_VDD_CPUA_INIT_VOLTAGE	  959	    //CPUA voltage
#define AML_VDD_CPUB_INIT_VOLTAGE	  959	    //CPUB voltage
#define AML_VDD_CPUA_SRAM__INIT_VOLTAGE	  959	    //CPUA_SRAM voltage
#define AML_VDD_CPUB_SRAM__INIT_VOLTAGE	  959	    //CPUB_SRAM voltage
#define AML_VDDEE_INIT_VOLTAGE    810       // VDDEE voltage
...
/* define for debian system */
#ifdef CONFIG_BUILD_DEBIAN_SYSTEM
#include "a9_by401_debian.h"
#else
#define SYSTEM_PRI_COMMANDS " \0"
#define SYSTEM_PRI_ENV_SETTINGS  " \0"
#endif

#define VOUT_OSD_LOGO_CMD         "osd open;osd clear;run load_bmp_logo;bmp scale;"

#define VOUT_HDMITX_HDMI_CMD2     "vpp hdrpkt;"

#ifdef CONFIG_HDMITX_ONLY
	#define CFG_EXTRA_ENV_SETTINGS \
		SYSTEM_PRI_COMMANDS \
		SYSTEM_PRI_ENV_SETTINGS \
		"scramble_reg=0xfe02e030\0"\
		"uart_base=0xffa1e000\0"\
		"usb_burning=" CONFIG_USB_TOOL_ENTRY "\0"\
		"panel_type=vbyone_1\0"\
		"panel1_type=lvds_1\0"\
...
//for common env list, please maintain it in board/amlogic/env/linux.env
	#define CFG_EXTRA_ENV_SETTINGS \
		...
		"dv_fw_dir=/oem/firmware/dovi_fw.bin\0"\
		"hdr_policy=1\0"\
		"hdr_preferred_policy=1\0"\
		"frac_rate_policy=1\0"\
		"board=Akee\0"\
		"kvm_arm_mode=protected\0"
#endif

...
#define BL2_CONFIG (AB_BOOT | BL2_FASTBOOT)

#if defined(CONFIG_BL32_FASTBOOT)
#if defined(CONFIG_BL32_128M)
#define BL32_CONFIG  (BIT(0) | BIT(2))
#else
#define BL32_CONFIG  (BIT(0) | BIT(1))
#endif
#else
#define BL32_CONFIG BIT(0)
#endif
...
#define MMU_USE_PAGE_TABLE
#ifdef MMU_USE_PAGE_TABLE
#define MMU_PAGE_TABLE_SIZE  (1024 * 4)
#endif

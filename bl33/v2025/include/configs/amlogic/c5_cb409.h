 ...
 */
#define AML_VCCK_INIT_VOLTAGE	  949	    //VCCK power up voltage
#define AML_VDDEE_INIT_VOLTAGE    810       // VDDEE power up voltage
#define AML_VDDDDR_INIT_VOLTAGE   810       // VDDDDR power up voltage for lp4x
...
#endif// #ifndef CONFIG_PXP_EMULATOR
...
/* acs __bl2_reg flag for enable bl22, support a/b
 * BIT(0) 1: enable BL22
 * BIT(1) 1: support A/B partition
 *		  0: support recovery
 * BIT(3) 1: enable fastboot & firmware header
 * BIT(4) 1: disable bl32
 */

#ifdef CONFIG_AB_BOOT
#define AB_BOOT    BIT(1)
#else
#define AB_BOOT    0
#endif

#ifdef CONFIG_BOOT_FASTBOOT
#define BL2_FASTBOOT	(BIT(0) | BIT(3))
#else
#define BL2_FASTBOOT    0
#endif

#ifdef CONFIG_BL32_FASTBOOT
#define DISABLE_BL32	BIT(4)
#else
#define DISABLE_BL32    0
#endif

#define BL2_CONFIG (AB_BOOT | BL2_FASTBOOT | DISABLE_BL32)
...
#define CONFIG_BL3_REE_SIZE				0x182000
#define CONFIG_BL3_TEE_SIZE				0x0C2000

#define BOOTLOADER_MODE_NAND			ADVANCE_BOOTLOADER
#define BOOTLOADER_MODE_SNAND			ADVANCE_BOOTLOADER
#if defined(CONFIG_BOOT_FASTBOOT)
 ...
 */
#define BOARD_CONFIG_BL2_LAYOUT_TYPE		2

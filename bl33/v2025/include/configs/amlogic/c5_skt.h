...
#define AML_VDDDDR_INIT_VOLTAGE   810       // VDDDDR power up voltage
 ...
 */
#define BL2_FASTBOOT	BIT(3)
#if defined(CONFIG_BOOT_FASTBOOT)  /* fastboot */
#define BL2_CONFIG (BIT(0) | BL2_FASTBOOT)
#else /* normal boot */
#define BL2_CONFIG 0
#endif

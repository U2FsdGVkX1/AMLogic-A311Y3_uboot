...
#define AML_VCCK_INIT_VOLTAGE	  1029	    //VCCK power up voltage
#define AML_VDDEE_INIT_VOLTAGE    900       // VDDEE power up voltage
...
#define CFG_EXTRA_ENV_SETTINGS \
	...
	"loadaddr=0x9000000\0"\
	"boot_part=boot\0"\
	"recovery_part=recovery\0"\
	"Irq_check_en=0\0"\
	"storeargs=" \
		"setenv bootargs console=ttyAML0,921600 earlycon=meson,0xfe078000 rootfstype=squashfs,ubifs 8250_core.nr_uarts=0 otg_device=${otg_device}"\
		"\0"\
	"boot_kernel=" \
		"store read 0x10000000 kernel 0 0x4000000;"\
		"store rsv read dtb 0x30000000 0x10000;"\
...
//#define CONFIG_AMLOGIC_ENV_ENCRYPT 1	// open by project
#define CONFIG_FIT 1

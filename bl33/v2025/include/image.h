...
int vendor_boot_image_check_header(const struct andr_vnd_boot_img_hdr * hdr);
 ...
 */
#ifdef CONFIG_AMLOGIC_MODIFY
int android_image_get_second(const struct andr_boot_img_hdr_v0 *hdr, ulong *second_data, ulong *second_len);
#else

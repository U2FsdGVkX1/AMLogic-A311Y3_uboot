...
if [ "$DV_SIGNING_SCHEME" == "rsa-mldsa" ] || [ "$DV_SIGNING_SCHEME" == "mldsa" ] ; then
  BB1ST_ARGS="${BB1ST_ARGS} --infile-signkey-device-lvl1-pqc=${BASEDIR_BOOTBLOBS_SIGKEY_ROOT}/key/level-1-mldsa-priv.pem"
  BB1ST_ARGS="${BB1ST_ARGS} --infile-signkey-device-lvl2-pqc=${BASEDIR_BOOTBLOBS_SIGKEY_ROOT}/key/level-2-mldsa-priv.pem"
  BB1ST_ARGS="${BB1ST_ARGS} --infile-pubkey-device-lvl2cert-pqc=${BASEDIR_BOOTBLOBS_SIGKEY_ROOT}/key/level-2-mldsa-pub.pem"
fi
